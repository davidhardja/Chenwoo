...
public class LoadScannerActivity extends BaseActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        ...
        Call<Wrapper> call = getService().loadPackage(getSession().getAccessToken(), rawResult.getText());
    ...
    private void showDialog(boolean b, String s) {
        ...
        rlWrapper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mScannerView.resumeCameraPreview(LoadScannerActivity.this);
                dialog.dismiss();
            }
        });
